...
export function ContactHero() {
  return (
    <section className="relative overflow-hidden bg-ink pb-16 pt-12 lg:pt-16">
      <div aria-hidden="true" className="pointer-events-none absolute left-1/2 top-1/4 size-96 -translate-x-1/2 rounded-full bg-brand-teal/10 blur-3xl" />
      <div aria-hidden="true" className="pointer-events-none absolute right-10 top-1/3 size-72 rounded-full bg-brand-green/10 blur-3xl" />
